...
export function CategoryBanner({ name, slug, productCount }: Props) {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-1/2 right-0 translate-x-6 -translate-y-1/2 opacity-[0.08] select-none"
      >
      ...
      <div className="relative flex flex-col gap-2.5">
        ...
        <div>
          ...
          <p className="mt-1 max-w-sm text-sm leading-relaxed text-gray-500">{tagline}</p>
        </div>
