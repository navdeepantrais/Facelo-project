    ...
    <MarketplaceLayout profile={user} showFooter>
      ...
      <section className="relative overflow-hidden border-b bg-gradient-to-br from-[#f0ebff] via-violet-50/50 to-white">
        ...
        <div aria-hidden="true" className="pointer-events-none absolute inset-0">
          <div className="absolute top-0 left-[40%] h-[560px] w-[560px] -translate-y-1/4 rounded-full bg-violet-300/20 blur-[130px]" />
        </div>
          ...
          <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-violet-200 bg-white px-4 py-1.5 shadow-sm">
                ...
                <span className="text-[11px] font-semibold tracking-wider text-violet-700 uppercase">
              ...
              <p className="mx-auto mt-5 max-w-md text-base leading-relaxed text-gray-500 lg:mx-0">
                Real people. Real recommendations. Every product is handpicked by a creator you
                trust. Join the community redefined by authenticity.
              </p>
            ...
            {heroProducts.length >= 2 && (
              <div className="relative hidden py-8 lg:block lg:w-[460px] lg:shrink-0">
                ...
                <div
                  aria-hidden="true"
                  className="pointer-events-none absolute top-1/2 left-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-violet-400/15 blur-[80px]"
                />

                <div className="relative h-[500px]">
                  {/* Card 1 — top-left, tilted counter-clockwise, floats slowly */}
                  <div className="group absolute top-8 left-0 z-10 w-[215px] -rotate-[5deg] transition-all duration-300 hover:z-30 hover:-translate-y-3 hover:scale-[1.03] hover:rotate-0">
                  ...
                  <div className="group absolute top-0 right-0 z-20 w-[200px] rotate-[4deg] transition-all duration-300 hover:z-30 hover:-translate-y-3 hover:scale-[1.03] hover:rotate-0">
                    <HeroProductCard product={heroProducts[1]} />
                  </div>

                  {/* Card 3 — bottom-left, tilted clockwise */}
                  {heroProducts[2] && (
                    <div className="group absolute bottom-0 left-4 z-10 w-[200px] rotate-[3deg] transition-all duration-300 hover:z-30 hover:-translate-y-3 hover:scale-[1.03] hover:rotate-0">
                  ...
                  {heroProducts[3] && (
                    <div className="group absolute right-2 bottom-4 z-20 w-[195px] -rotate-[4deg] transition-all duration-300 hover:z-30 hover:-translate-y-3 hover:scale-[1.03] hover:rotate-0">
            ...
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Browse products across all creator-curated categories
                </p>
              </div>
              <Link
                href="/marketplace"
