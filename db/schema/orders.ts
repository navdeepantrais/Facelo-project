...
export const orders = pgTable('orders', {
  ...
  attributionSessionId: uuid('attribution_session_id').references(() => sessions.id, { onDelete: 'set null' }),
...
export const commissions = pgTable('commissions', {
  id: uuid('id').primaryKey().default(sql`gen_random_uuid()`),
  orderItemId: uuid('order_item_id').references(() => orderItems.id, { onDelete: 'cascade' }).notNull().unique(),
