...
export const adminRolesData: AdminRoleData[] = [
  ...
  },
  {
    ...
    description: 'Reviews creator applications, approves or suspends creator accounts, and monitors creator stats.',
    permissions: [
      { resource: 'creators',    canRead: true,  canWrite: true,  canApprove: true  },
  ...
  {
    name: 'order_manager',
    description: 'Handles order lifecycle, initiates refunds, and has visibility into payment records.',
    permissions: [
      { resource: 'orders',      canRead: true,  canWrite: true,  canApprove: true  },
      { resource: 'refunds',     canRead: true,  canWrite: true,  canApprove: true  },
  ...
  {
    name: 'moderator',
    description: 'Reviews and approves or rejects creator video submissions, and can suspend user accounts.',
    permissions: [
      { resource: 'videos',   canRead: true,  canWrite: true,  canApprove: true  },
      { resource: 'creators', canRead: true,  canWrite: false, canApprove: false },
