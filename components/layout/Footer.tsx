        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/marketplace" className="hover:text-foreground">All Products</Link></li>
              <li><Link href="/trending" className="hover:text-foreground">Trending</Link></li>
              <li><Link href="/videos" className="hover:text-foreground">Shop from Videos</Link></li>
